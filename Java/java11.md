...
- String method
  ...
  | String replace(char old, char nw)                                                                                                                                                                                                                                  | 문자열 중의 문자(old)를 새로운 문자(nw)로 바꾼 문자열을 반환                                          | String s1 = "Hello"; <br /> String s2 = s1.replace('H', 'C');                                                                                                                                                                                                                | s2 = "Cello"                                                                                   |
  | String replace(CharSequence old, CharSequence nw)                                                                                                                                                                                                                  | 문자열 중의 문자(old)를 새로운 문자(nw)로 모두 바꾼 문자열을 반환                                     | String s1 = "Hellollo"; <br /> String s2 = s1.replace("ll", "LL");                                                                                                                                                                                                           | s2 = "HeLLoLLo"                                                                                |
  ...
  | boolean startsWith(String prefix)                                                                                                                                                                                                                                  | 주어진 문자열(prefix)로 시작하는지 검사                                                               | String s = "java.lang.java"; <br /> String c = s.startsWith("java"); <br /> String p = s.startsWith("lang");                                                                                                                                                                 | c = true <br /> p = false                                                                      |
